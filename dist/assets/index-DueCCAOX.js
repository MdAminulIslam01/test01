...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(e,t,n){let r=new Float32Array(Yo),i=new U(0,1,0);return new Sa({name:`SphericalGaussianBlur`,defines:{n:Yo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function us(){return new Sa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:fs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ds(){return new Sa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fs(),fragmentShader:`
	...
	`}var ps=class extends sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};ju.BlurDirectionX=new H(1,0),ju.BlurDirectionY=new H(0,1);var Mu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Nu=class extends xu{constructor(){super(),this.isOutputPass=!0,this.uniforms=ya.clone(Mu.uniforms),this.material=new Ca({name:Mu.name,uniforms:this.uniforms,vertexShader:Mu.vertexShader,fragmentShader:Mu.fragmentShader}),this._fsQuad=new wu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},G.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Pu=[{index:0,zoom:0,name:`Earth and Moon`,distance:14},{index:1,zoom:1,name:`Inner Solar System`,distance:190},{index:2,zoom:2,name:`Outer Solar System`,distance:520},{index:3,zoom:3,name:`Kuiper Belt and Oort Cloud`,distance:1250},{index:4,zoom:4,name:`Local Interstellar Cloud`,distance:2900},{index:5,zoom:5,name:`Orion Arm`,distance:7400},{index:6,zoom:6,name:`Milky Way`,distance:16e3},{index:7,zoom:7,name:`Local Group`,distance:36e3},{index:8,zoom:8,name:`Observable Universe`,distance:78e3}],Fu=Pu[0].zoom,Iu=Pu[Pu.length-1].zoom;function Lu(e,t=Fu,n=Iu){return Math.min(n,Math.max(t,e))}function Ru(e,t,n,r){return e+(t-e)*(1-Math.exp(-n*r))}function zu(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function Bu(e,t,n=.95){let r=Math.abs(e-t);return 1-zu(n*.35,n,r)}function Vu(e,t,n,r,i){let a=zu(t,n,e),o=1-zu(r,i,e);return Math.min(a,o)}function Hu(e){let t=Lu(e),n=Math.min(Math.floor(t),Pu.length-2),r=n+1,i=Pu[n],a=Pu[r],o=zu(i.zoom,a.zoom,t);return Math.exp(Math.log(i.distance)*(1-o)+Math.log(a.distance)*o)}function Uu(e){return Pu.reduce((t,n)=>Math.abs(n.zoom-e)<Math.abs(t.zoom-e)?n:t,Pu[0]).name}var Q={earth:`/textures/earth_day.jpg`,earthClouds:`/textures/earth_clouds.jpg`,earthNight:`/textures/earth_night.jpg`,moon:`/textures/moon.jpg`,sun:`/textures/sun.jpg`,mercury:`/textures/mercury.jpg`,venus:`/textures/venus.jpg`,mars:`/textures/mars.jpg`,jupiter:`/textures/jupiter.jpg`,saturn:`/textures/saturn.jpg`,uranus:`/textures/uranus.jpg`,neptune:`/textures/neptune.jpg`},Wu=23,Gu=2.15,Ku=[{name:`Mercury`,radius:.45,orbit:12,speed:.74,spin:.65,initialAngle:.5,texture:Q.mercury,fallback:[`#7a746b`,`#373430`]},{name:`Venus`,radius:.78,orbit:17,speed:.52,spin:-.18,initialAngle:2.25,texture:Q.venus,fallback:[`#d8b26f`,`#6d5635`]},{name:`Earth`,radius:1.18,orbit:Wu,speed:.42,spin:1,initialAngle:0,tilt:.41,texture:Q.earth,fallback:[`#2c6d9e`,`#113047`]},{name:`Mars`,radius:.62,orbit:31,speed:.32,spin:.93,initialAngle:4.2,texture:Q.mars,fallback:[`#b05c39`,`#3d1d17`]},{name:`Jupiter`,radius:2.55,orbit:45,speed:.2,spin:1.65,initialAngle:1.45,texture:Q.jupiter,fallback:[`#d1a679`,`#725743`]},{name:`Saturn`,radius:2.05,orbit:63,speed:.15,spin:1.42,initialAngle:2.95,texture:Q.saturn,fallback:[`#d6bd82`,`#67553b`]},{name:`Uranus`,radius:1.42,orbit:80,speed:.11,spin:1.2,initialAngle:4.85,texture:Q.uranus,fallback:[`#8fd3dc`,`#31515d`]},{name:`Neptune`,radius:1.38,orbit:96,speed:.09,spin:1.18,initialAngle:5.75,texture:Q.neptune,fallback:[`#426ec7`,`#0b1e48`]}];function qu(e,t,n){let r=new Ja(e).load(t,e=>{e.colorSpace=Xe,e.needsUpdate=!0},void 0,()=>{let e=document.createElement(`canvas`);e.width=256,e.height=128;let t=e.getContext(`2d`),i=t.createLinearGradient(0,0,256,128);i.addColorStop(0,n[0]),i.addColorStop(.55,n[1]),i.addColorStop(1,n[0]),t.fillStyle=i,t.fillRect(0,0,e.width,e.height),r.image=e,r.needsUpdate=!0});return r.colorSpace=Xe,r.wrapS=p,r.wrapT=m,r}function Ju(e,t){e.visible=t>.015,e.traverse(e=>{let n=e.material;if(!n)return;let r=Array.isArray(n)?n:[n];for(let e of r)`opacity`in e&&(e.userData.baseOpacity??=e.opacity,e.transparent=!0,e.opacity=e.userData.baseOpacity*t)})}function Yu(e,t,n=1){return new Di(new pa(e,64,32),new Sa({uniforms:{glowColor:{value:new K(t)},intensity:{value:n}},vertexShader:`
        varying vec3 vNormal;
        void main() {
      ...
      `,transparent:!0,blending:2,depthWrite:!1,side:1}))}function Xu(e,t=10403071){let n=[];for(let t=0;t<=220;t+=1){let r=t/220*Math.PI*2;n.push(new U(Math.cos(r)*e,0,Math.sin(r)*e))}return new qi(new Br().setFromPoints(n),new zi({color:t,transparent:!0,opacity:.035,blending:2,depthWrite:!1}))}function Zu(e,t,n,r,i,a){let o=new Float32Array(e*3),s=new Float32Array(e*3),c=new K;for(let i=0;i<e;i+=1){let e=t+Math.random()**.72*(n-t),l=Math.random()*Math.PI*2,u=(Math.random()-.5)*r;o[i*3]=Math.cos(l)*e,o[i*3+1]=u,o[i*3+2]=Math.sin(l)*e,c.setHSL(a+Math.random()*.04,.32+Math.random()*.25,.44+Math.random()*.32),s[i*3]=c.r,s[i*3+1]=c.g,s[i*3+2]=c.b}let l=new Br;return l.setAttribute(`position`,new Tr(o,3)),l.setAttribute(`color`,new Tr(s,3)),new ra(l,new Qi({size:i,vertexColors:!0,transparent:!0,opacity:0,blending:2,depthWrite:!1,sizeAttenuation:!0}))}function Qu(e){return e.orbit*Gu}function $u(e,t){let n=new Rn,r=new Di(new pa(t.radius,64,32),new wa({map:qu(e,t.texture,t.fallback),roughness:.88,metalness:0}));return r.name=t.name,r.position.x=Qu(t),r.rotation.z=t.tilt??0,n.rotation.y=t.initialAngle,n.add(r),{pivot:n,mesh:r,spec:t}}function ed(e){let t=new Rn;t.name=`Earth Moon System`;let n=new Di(new pa(2.5,96,48),new wa({map:qu(e,Q.earth,[`#2d78ad`,`#061a2d`]),emissiveMap:qu(e,Q.earthNight,[`#050716`,`#11172f`]),emissive:new K(16766624),emissiveIntensity:.045,roughness:.82}));n.rotation.z=.41,t.add(n);let r=new Di(new pa(2.545,96,48),new wa({map:qu(e,Q.earthClouds,[`#ffffff`,`#7892aa`]),transparent:!0,opacity:.14,depthWrite:!1,roughness:.65}));r.rotation.z=.41,t.add(r),t.add(Yu(2.6,10341631,.18));let i=new Rn,a=new Di(new pa(.62,64,32),new wa({map:qu(e,Q.moon,[`#aaa69b`,`#3d3c39`]),roughness:.95}));a.position.x=7.4,i.add(a),t.add(i);let o=Xu(7.4,9414854);t.add(o);let s=new Rn;s.name=`Solar System`,s.scale.setScalar(1.2);let c=new Di(new pa(4.4,96,48),new gi({map:qu(e,Q.sun,[`#fff2a0`,`#e45b1e`])}));s.add(c),s.add(Yu(5.15,16757836,.72)),s.add(new co(16765841,30,1100,1.35));let l=Ku.map(t=>$u(e,t)),u=l.map(e=>e.spec.initialAngle),d=Zu(3400,35*Gu,40*Gu,1.5,.42,.08),f=Zu(5800,112*Gu,168*Gu,8,.85,.58),p=Zu(9500,250*Gu,520*Gu,210,1.3,.62);p.rotation.x=.28,p.rotation.z=-.18,s.add(d,f,p);for(let e of l)if(s.add(Xu(Qu(e.spec))),s.add(e.pivot),e.spec.name===`Saturn`){let t=new Di(new fa(e.spec.radius*1.45,e.spec.radius*2.35,128),new wa({color:13285769,transparent:!0,opacity:.58,side:2,roughness:.9,depthWrite:!1}));t.rotation.x=Math.PI*.47,t.position.copy(e.mesh.position),e.pivot.add(t)}let m=l.find(e=>e.spec.name===`Earth`);return Ju(s,0),{earthMoon:t,solarSystem:s,update:(e,o,h)=>{n.rotation.y+=e*.22,r.rotation.y+=e*.28,a.rotation.y+=e*.09,i.rotation.y+=e*.065,c.rotation.y+=e*.09;let g=zu(1.08,1.68,h);for(let t=0;t<l.length;t+=1){let n=l[t];n.spec.name!==`Earth`&&(u[t]+=e*n.spec.speed*g),n.pivot.rotation.y=u[t],n.mesh.rotation.y+=e*n.spec.spin}Ju(t,Vu(h,-.2,0,.72,1.18)),Ju(s,Math.max(Bu(h,1.2,1.05),Vu(h,1.15,1.8,3.85,4.55)*.82));let _=1.1+h*.12;if(s.scale.setScalar(_),Ju(d,Vu(h,1.25,1.65,2.35,2.9)),Ju(f,Vu(h,2.05,2.55,3.35,3.95)),Ju(p,Vu(h,2.65,3.15,3.8,4.45)*.78),m){let e=Qu(m.spec);s.position.set(-e*_,0,0)}else s.position.set(-Wu*Gu*_,0,0)},dispose:()=>{for(let e of[t,s])e.traverse(e=>{if(e instanceof Di||e instanceof qi||e instanceof ra){e.geometry.dispose();let t=e.material,n=Array.isArray(t)?t:[t];for(let e of n)e.dispose()}})}}}function $(e,t){return e+Math.random()*(t-e)}function td(){let e=document.createElement(`canvas`);e.width=96,e.height=96;let t=e.getContext(`2d`),n=t.createRadialGradient(48,48,0,48,48,48);n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.13,`rgba(255,250,236,0.86)`),n.addColorStop(.38,`rgba(180,204,255,0.22)`),n.addColorStop(.72,`rgba(88,126,210,0.055)`),n.addColorStop(1,`rgba(0,0,0,0)`),t.fillStyle=n,t.fillRect(0,0,96,96);let r=new oa(e);return r.colorSpace=Xe,r}function nd(e=`#dce9ff`,t=`#ffbe78`){let n=document.createElement(`canvas`);n.width=512,n.height=512;let r=n.getContext(`2d`);r.translate(256,256);let i=r.createRadialGradient(0,0,5,0,0,230);i.addColorStop(0,e),i.addColorStop(.2,`rgba(170,197,255,0.45)`),i.addColorStop(.6,`rgba(66,92,176,0.14)`),i.addColorStop(1,`rgba(0,0,0,0)`),r.fillStyle=i,r.beginPath(),r.ellipse(0,0,218,74,0,0,Math.PI*2),r.fill();for(let e=0;e<3;e+=1){r.strokeStyle=e===1?t:`rgba(205,224,255,0.6)`,r.lineWidth=7,r.beginPath();for(let t=0;t<150;t+=1){let n=t/149,i=n*Math.PI*2.1+e*(Math.PI*2/3),a=12+n*210,o=Math.cos(i)*a,s=Math.sin(i)*a*.32;t===0?r.moveTo(o,s):r.lineTo(o,s)}r.stroke()}let a=new oa(n);return a.colorSpace=Xe,a}function rd(e,t,n,r,i=!0){let a=new Float32Array(e*3),o=new Float32Array(e*3),s=new K;for(let r=0;r<e;r+=1){let e=$(t,n),i=Math.random()*Math.PI*2,c=Math.acos($(-1,1));a[r*3]=e*Math.sin(c)*Math.cos(i),a[r*3+1]=e*Math.cos(c),a[r*3+2]=e*Math.sin(c)*Math.sin(i);let l=Math.random()<.62?$(.08,.15):$(.55,.64);s.setHSL(l,$(.04,.34),$(.72,1)),o[r*3]=s.r,o[r*3+1]=s.g,o[r*3+2]=s.b}let c=new Br;return c.setAttribute(`position`,new Tr(a,3)),c.setAttribute(`color`,new Tr(o,3)),new ra(c,new Qi({size:r,map:td(),vertexColors:!0,transparent:!0,opacity:1,blending:2,depthWrite:!1,sizeAttenuation:i}))}function id(e){let t=new Float32Array(e*3),n=new Float32Array(e*3),r=new K;for(let i=0;i<e;i+=1){let e=i%4,a=Math.random()**.78*5800+180,o=a*.0022,s=e*(Math.PI*2/4)+o+$(-.28,.28),c=Math.random()**2.2*560;t[i*3]=Math.cos(s)*a+$(-c,c),t[i*3+1]=$(-95,95)*(1-a/8200)+$(-28,28),t[i*3+2]=Math.sin(s)*a+$(-c,c);let l=Math.max(0,1-a/2900);r.setHSL(.6-l*.48,.24+l*.18,.52+Math.random()*.3),n[i*3]=r.r,n[i*3+1]=r.g,n[i*3+2]=r.b}let i=new Br;return i.setAttribute(`position`,new Tr(t,3)),i.setAttribute(`color`,new Tr(n,3)),new ra(i,new Qi({size:11,map:td(),vertexColors:!0,transparent:!0,opacity:0,blending:2,depthWrite:!1,sizeAttenuation:!0}))}function ad(e){let t=new Float32Array(e*3),n=new Float32Array(e*3),r=new K;for(let i=0;i<e;i+=1){let e=Math.random(),a=-.9+e*1.85,o=2400+e*6200+$(-460,460);t[i*3]=Math.cos(a)*o+$(-220,220),t[i*3+1]=$(-150,150),t[i*3+2]=Math.sin(a)*o+$(-520,520),r.setHSL($(.08,.65),$(.08,.38),$(.56,.9)),n[i*3]=r.r,n[i*3+1]=r.g,n[i*3+2]=r.b}let i=new Br;return i.setAttribute(`position`,new Tr(t,3)),i.setAttribute(`color`,new Tr(n,3)),new ra(i,new Qi({size:8,map:td(),vertexColors:!0,transparent:!0,opacity:0,blending:2,depthWrite:!1,sizeAttenuation:!0}))}function od(e){let t=new Rn,n=[nd(),nd(`#eaf0ff`,`#a6c8ff`),nd(`#fff0ce`,`#fd9f72`)];for(let r=0;r<e;r+=1){let e=new oi(new Kr({map:n[r%n.length],color:new K().setHSL($(.55,.68),$(.1,.38),$(.65,.95)),transparent:!0,opacity:0,blending:2,depthWrite:!1})),i=$(9e3,31e3),a=Math.random()*Math.PI*2,o=Math.acos($(-.92,.92));e.position.set(i*Math.sin(o)*Math.cos(a),i*Math.cos(o),i*Math.sin(o)*Math.sin(a));let s=$(130,650);e.scale.set(s*$(1.4,3.5),s,1),t.add(e)}return t}function sd(){let e=new Rn,t=[nd(),nd(`#eaf0ff`,`#88b7ff`),nd(`#fff1cf`,`#f6a66e`)];for(let n of[{position:[0,0,0],scale:[4200,1250,1]},{position:[13500,1200,-5400],scale:[5600,1450,1]},{position:[-9200,-850,8800],scale:[1650,620,1]},{position:[6400,-1900,10400],scale:[1350,520,1]}]){let r=new oi(new Kr({map:t[e.children.length%t.length],transparent:!0,opacity:0,blending:2,depthWrite:!1}));r.position.set(n.position[0],n.position[1],n.position[2]),r.scale.set(n.scale[0],n.scale[1],n.scale[2]),e.add(r)}for(let n=0;n<28;n+=1){let r=new oi(new Kr({map:t[n%t.length],color:new K().setHSL($(.55,.7),.22,$(.58,.9)),transparent:!0,opacity:0,blending:2,depthWrite:!1})),i=$(8e3,24e3),a=Math.random()*Math.PI*2,o=$(-4200,4200);r.position.set(Math.cos(a)*i,o,Math.sin(a)*i);let s=$(420,1100);r.scale.set(s*$(1.8,3.8),s,1),e.add(r)}return e}function cd(e){let t=new Rn,n=[];for(let t=0;t<e;t+=1){let e=$(28e3,92e3),t=Math.random()*Math.PI*2,r=Math.acos($(-.82,.82));n.push(new U(e*Math.sin(r)*Math.cos(t),e*Math.cos(r),e*Math.sin(r)*Math.sin(t)))}let r=new Br().setFromPoints(n),i=new Float32Array(e*3),a=new K;for(let t=0;t<e;t+=1)a.setHSL($(.57,.67),$(.12,.38),$(.45,.8)),i[t*3]=a.r,i[t*3+1]=a.g,i[t*3+2]=a.b;r.setAttribute(`color`,new Tr(i,3)),t.add(new ra(r,new Qi({size:140,map:td(),vertexColors:!0,transparent:!0,opacity:0,blending:2,depthWrite:!1})));let o=[];for(let e=0;e<n.length;e+=1){let t=n[e],r=n[(e+1)%n.length],i=1/0;for(let a=0;a<n.length;a+=1){if(e===a)continue;let o=t.distanceToSquared(n[a]);o<i&&(i=o,r=n[a])}o.push(t,r)}return t.add(new Zi(new Br().setFromPoints(o),new zi({color:12110056,transparent:!0,opacity:0,blending:2,depthWrite:!1}))),t}function ld(e,t){e.visible=t>.01;let n=e.material;n.opacity=t}function ud(e,t){e.visible=t>.01;for(let n of e.children)n instanceof oi&&(n.material.userData.baseOpacity??=$(.72,1),n.material.opacity=t*n.material.userData.baseOpacity)}function dd(e,t){e.visible=t>.01,e.traverse(e=>{let n=e.material;if(!n)return;let r=Array.isArray(n)?n:[n];for(let e of r)`opacity`in e&&(e.userData.baseOpacity??=e.opacity||1,e.transparent=!0,e.opacity=e.userData.baseOpacity*t)})}function fd(){let e=new Rn,t=rd(9200,85,1850,1.65,!1),n=rd(16500,1900,12e3,5.4),r=rd(8400,1200,5600,7.2),i=ad(2e4),a=rd(25e3,1e4,102e3,12.5),o=id(34e3),s=sd(),c=od(240),l=cd(130);return e.add(t,n,r,i,a,o,s,c,l),{root:e,update:(e,u,d)=>{t.rotation.y+=e*.004,n.rotation.y-=e*.0025,r.rotation.y+=e*.0018,i.rotation.y=-.28+u*.0018,a.rotation.y+=e*.0012,o.rotation.y=u*.002,s.rotation.y=u*.001,c.rotation.y=-u*8e-4,l.rotation.y=u*35e-5,ld(t,Math.max(.22,.95-d*.095)),ld(n,Vu(d,3.1,3.65,4.85,5.45)*.86),ld(r,Vu(d,2.55,3.25,4.65,5.2)*.3),ld(i,Vu(d,4.35,4.95,5.95,6.55)*.92),ld(a,Vu(d,5.25,6.05,8.1,8.38)*.58+Bu(d,8,1.35)*.3),ld(o,Vu(d,5.55,6.1,6.65,7.08)),o.scale.setScalar(.62+d*.08),ud(s,Vu(d,6.55,6.98,7.46,7.84)*.84),ud(c,Vu(d,7.25,7.7,8.12,8.38)*.72),dd(l,Vu(d,7.5,7.86,8.15,8.42)*.34)},dispose:()=>{e.traverse(e=>{e instanceof ra&&(e.geometry.dispose(),e.material.dispose()),e instanceof Zi&&(e.geometry.dispose(),e.material.dispose()),e instanceof oi&&e.material.dispose()})}}}function pd(){return new Di(new pa(22e4,96,48),new Sa({vertexShader:`
        varying vec3 vWorld;
        void main() {
      ...
      `,side:1,depthWrite:!1}))}var md=class{mount;options;scene=new Kn;camera=new oo(56,1,.02,32e4);spaceDome=pd();renderer;controls;composer;bloomPass;loadingManager=new Ua;bodySystem;starfieldSystem;animationFrame=0;zoom=0;targetZoom=0;currentLevel=``;disposed=!1;lowFpsSeconds=0;lastTime=performance.now()/1e3;elapsedTime=0;constructor(e,t={}){this.mount=e,this.options=t,this.loadingManager.onLoad=()=>this.options.onReady?.(),this.loadingManager.onError=()=>this.options.onReady?.(),this.renderer=new Xl({antialias:!0,alpha:!1,powerPreference:`high-performance`}),this.renderer.setClearColor(0,1),this.renderer.outputColorSpace=Xe,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.08,this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.mount.appendChild(this.renderer.domElement),this.controls=new su(this.camera,this.renderer.domElement),this.controls.enableDamping=!0,this.controls.dampingFactor=.055,this.controls.enableZoom=!1,this.controls.enablePan=!1,this.controls.rotateSpeed=.42,this.controls.target.set(0,0,0),this.composer=new Ou(this.renderer),this.composer.addPass(new ku(this.scene,this.camera)),this.bloomPass=new ju(new H(1,1),.34,.46,.16),this.composer.addPass(this.bloomPass),this.composer.addPass(new Nu),this.spaceDome.renderOrder=-100,this.scene.add(this.spaceDome),this.scene.add(new po(16777215,.035));let n=new fo(16774879,2.35);n.position.set(-7,5,8),this.scene.add(n),this.bodySystem=ed(this.loadingManager),this.starfieldSystem=fd(),this.scene.add(this.starfieldSystem.root,this.bodySystem.earthMoon,this.bodySystem.solarSystem),this.camera.position.set(0,4.2,Hu(0)),this.camera.lookAt(this.controls.target),this.resize(),this.updateLevelName(),window.addEventListener(`resize`,this.resize),this.renderer.domElement.addEventListener(`wheel`,this.handleWheel,{passive:!1}),this.animationFrame=window.requestAnimationFrame(this.animate)}handleWheel=e=>{e.preventDefault();let t=Math.sign(e.deltaY)*Math.min(.32,Math.abs(e.deltaY)*.0018);this.targetZoom=Lu(this.targetZoom+t)};resize=()=>{let e=Math.max(1,this.mount.clientWidth),t=Math.max(1,this.mount.clientHeight);this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1),this.composer.setSize(e,t),this.bloomPass.setSize(e,t)};updateCamera(e){this.zoom=Ru(this.zoom,this.targetZoom,4.2,e);let t=Hu(this.zoom),n=this.camera.position.clone().sub(this.controls.target);n.lengthSq()<.001&&n.set(0,.28,1),n.normalize(),this.camera.position.copy(this.controls.target).addScaledVector(n,t),this.camera.near=Math.max(.02,t/3e4),this.camera.far=Math.max(2e3,t*3.5),this.camera.updateProjectionMatrix()}updateLevelName(){let e=Uu(this.zoom);e!==this.currentLevel&&(this.currentLevel=e,this.options.onLevelChange?.(e))}adaptQuality(e){let t=1/Math.max(e,.001);this.lowFpsSeconds=t<34?this.lowFpsSeconds+e:Math.max(0,this.lowFpsSeconds-e),this.lowFpsSeconds>2.5&&(this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,1.35)),this.bloomPass.strength=.28)}animate=()=>{if(this.disposed)return;let e=performance.now()/1e3,t=Math.min(e-this.lastTime,.05);this.lastTime=e,this.elapsedTime+=t;let n=this.elapsedTime;this.controls.update(),this.updateCamera(t),this.spaceDome.position.copy(this.camera.position),this.bodySystem.update(t,n,this.zoom),this.starfieldSystem.update(t,n,this.zoom),this.updateLevelName(),this.adaptQuality(t),this.composer.render(),this.animationFrame=window.requestAnimationFrame(this.animate)};dispose(){this.disposed=!0,window.cancelAnimationFrame(this.animationFrame),window.removeEventListener(`resize`,this.resize),this.renderer.domElement.removeEventListener(`wheel`,this.handleWheel),this.controls.dispose(),this.bodySystem.dispose(),this.starfieldSystem.dispose(),this.composer.dispose(),this.renderer.dispose(),this.renderer.domElement.remove()}},hd=e((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),gd=e(((e,t)=>{t.exports=hd()}))();function _d(){let e=(0,l.useRef)(null),[t,n]=(0,l.useState)(!1),[r,i]=(0,l.useState)(Pu[0].name);return(0,l.useEffect)(()=>{if(!e.current)return;let t=new md(e.current,{onReady:()=>n(!0),onLevelChange:i});return()=>t.dispose()},[]),(0,gd.jsxs)(`main`,{className:`universe-shell`,children:[(0,gd.jsx)(`div`,{ref:e,className:`universe-canvas`,"aria-label":`3D immersive universe panorama`}),!t&&(0,gd.jsx)(`div`,{className:`loader`,children:`Loading deep space`}),(0,gd.jsx)(`div`,{className:`scale-indicator`,"aria-live":`polite`,children:r})]})}(0,u.createRoot)(document.getElementById(`root`)).render((0,gd.jsx)(l.StrictMode,{children:(0,gd.jsx)(_d,{})}));